...
// Use proxy local em desenvolvimento, API direta em produção
const API_BASE_URL = import.meta.env.DEV ? "http://localhost:3001/api" : "/api"; // Em produção, configure seu servidor para fazer proxy de /api
