...
export class DefaultService {
     ...
     * @param requestBody
     * @param xCreaoApiName API name identifier - must be "OpenAIGPTChat"
     * @param xCreaoApiPath API path identifier - must be "/v1/ai/zWwyutGgvEGWwzSa/chat/completions"
     * @param xCreaoApiId API ID identifier - must be "688a0b64dc79a2533460892c"
